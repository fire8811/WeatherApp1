...
#
# Created by: Jenson Jones and PyQt5 UI code generator 5.15.0
...
class Ui_MainWindow(object):
    ...
    def getWeather(self, MainWindow):
        ...
        try: 
            key = #* your api key here (https://openweathermap.org/appid to get one)
    ...
    def updateGUI(self, weatherData, zipcode):
        ...
        im = QPixmap("/Users/jj/PYTHON/QT/WeatherQT/weather_icons/%s" % iconFilename) #display the corresponding weather icon
